...
$sql= "SELECT comercios.id, comercios.nombre, comercios.telefono, comercios.ubicacion, comercios.adicional, comercios.horario, comercios.fecha, tipos.tipo, tipos.id FROM comercios INNER JOIN tipos ON tipos.id=comercios.tipo ORDER BY comercios.id";
